  ...
  async (error: AxiosError) => {
    ...
    if (
      ...
      try {
        ...
        // Avoid an infinite redirect loop: if we're already on the login
        // page (e.g. an unauthenticated bootstrap call 401'd there), don't
        // re-navigate with an ever-growing nested `redirect` param.
