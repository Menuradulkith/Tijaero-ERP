...
class Permissions:
    ...
    CREDIT_PAYMENT_VIEW = ("credit_payments", "view")
    CREDIT_PAYMENT_CREATE = ("credit_payments", "create")
    CREDIT_PAYMENT_UPDATE = ("credit_payments", "update")
    CREDIT_PAYMENT_DELETE = ("credit_payments", "delete")
    CASH_PAYMENT_VIEW = ("cash_payments", "view")
    CASH_PAYMENT_CREATE = ("cash_payments", "create")
    CASH_PAYMENT_UPDATE = ("cash_payments", "update")
    CASH_PAYMENT_DELETE = ("cash_payments", "delete")
